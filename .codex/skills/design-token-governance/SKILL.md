...
description: Define token taxonomy, naming, ownership, and change policy for the design system in this workspace.
metadata:
  source: local
...
Define design tokens, naming, ownership and change policy.
