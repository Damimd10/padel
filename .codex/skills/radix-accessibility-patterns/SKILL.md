---
name: radix-accessibility-patterns
description: Document accessibility patterns, keyboard behavior, focus management, and ARIA expectations when using Radix UI primitives in this workspace.
metadata:
  source: local
  origin: created in .codex/workflows/01-install-missing-skills.md
---

# Skill: radix-accessibility-patterns

## Purpose

Define accessibility expectations for Radix UI primitives and higher-level shadcn components.
