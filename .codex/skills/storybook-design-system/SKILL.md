...
description: Define Storybook documentation, story composition, controls, and governance for reusable UI components in this workspace.
metadata:
  source: local
  origin: curated in .codex/workflows/01-install-missing-skills.md
---
...
Define Storybook documentation, stories, controls and test strategy.
